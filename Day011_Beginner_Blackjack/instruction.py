...
# #################### Hints #####################
#
# Hint 1: Go to this website and try out the Blackjack US_States_Game:
...
# return 0 instead of the actual score. 0 will represent a blackjack in our US_States_Game.
#
...
# then the US_States_Game ends.
#
# Hint 10: If the US_States_Game has not ended, ask the user if they want to draw another card. If yes, then use the deal_card()
# function to add another card to the user_cards List. If no, then the US_States_Game has ended.
#
# Hint 11: The score will need to be rechecked with every new card drawn and the checks in Hint 9 need to be repeated
# until the US_States_Game ends.
#
...
#
# Hint 14: Ask the user if they want to restart the US_States_Game. If they answer yes, clear the console and
# start a new US_States_Game of blackjack and show the logo from art.py.
